  ...
  return (
    <div className="flex flex-col items-center justify-between content-container bg-gradient-to-b bg-main-2 px-8 py-6">
      ...
      <div className="text-center mt-16">
        <h1 className="text-4xl font-bold">Let Us Know Your Location!</h1>
        ...
        <p className="text-lg my-5 mx-auto max-w-[400px]">
      ...
      <div className="w-full flex flex-col items-center mb-10">
        ...
        <p className="text-sm mt-4 text-center max-w-[400px]">
